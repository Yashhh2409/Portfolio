...
const Header = () => {
  ...
  window.addEventListener("scroll", function () {
    ...
    // When the scroll is higher than 200 viewport this.innerHeight, add the scroll-header class to a tag with the header tag
  ...
  return (
    <header className="header">
      <nav className="nav container">
        ...
        <img src={Logo} className="nav__logo" alt="Yash" />
