...
const Data = () => {
    return (
        ...
        className="home__data">
            <h1 className="home__title">Yash Dhande
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description text-shine">
            I'm a passionate web developer dedicated to creating engaging and intuitive web experiences. With a strong foundation in React.js and an ever-growing skill set
            </p>

            <a href="#contact" className="button button--flex animated-button">
                Say Hello
                <svg
                    class="button__icon"
                    xmlns="http://www.w3.org/2000/svg"
